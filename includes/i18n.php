...
function _mavo_contact_all_strings(): array {
	return [
		...
		'de' => [
			...
			'success'              => 'Vielen Dank, deine Nachricht wurde gesendet. Ich melde mich so bald wie möglich bei dir.',
			'error_summary'        => 'Bitte überprüfe die unten angezeigten Felder.',
			'error_name'           => 'Bitte gib deinen Namen ein (2 bis 80 Zeichen).',
			'error_email'          => 'Bitte gib eine gültige E-Mail-Adresse ein.',
			'error_reason'         => 'Bitte wähle einen Betreff.',
			'error_msg_short'      => 'Bitte schreib eine Nachricht mit mindestens 20 Zeichen.',
			'error_msg_long'       => 'Die Nachricht ist zu lang (maximal 5.000 Zeichen).',
			'error_msg_links'      => 'Die Nachricht enthält zu viele Links.',
			'error_rate_limit'     => 'In letzter Zeit wurden zu viele Nachrichten gesendet. Bitte versuche es später erneut.',
			'error_send_failed'    => 'Beim Senden ist ein Fehler aufgetreten. Bitte versuche es erneut oder verwende die direkte E-Mail-Adresse.',
			'privacy'              => 'Die über dieses Formular übermittelten Informationen dienen ausschließlich zur Beantwortung deiner Anfrage. Sie werden nicht verkauft, für Newsletter verwendet oder an externe Formularverwaltungsdienste weitergegeben.',
			// No collab page translation — keys omitted intentionally.
